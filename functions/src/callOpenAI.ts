...
interface OpenAIResponse {
  ...
  transactionId: string; // Return the transaction ID to the client
}
...
export const startEmotionalSupportSession = onCall(
  {
    secrets: [OPENAI_API_KEY, OPENAI_MODEL],
  },
...
export const analyzeEmotionWithTracking = onCall(
  {
    secrets: [OPENAI_API_KEY, OPENAI_MODEL],
  },
...
export const continueConversation = onCall(
  {
    secrets: [OPENAI_API_KEY, OPENAI_MODEL],
  },
  async (request: CallableRequest<{
...
export const processEmotionalChat = onCall(
  {
    secrets: [OPENAI_API_KEY, OPENAI_MODEL],
  },
  async (request: CallableRequest<{
