...
exports.generateSessionSummaries = exports.getWordFrequency = exports.getEmotionalTrends = exports.updateEmotionTrends = exports.updateWordFrequency = void 0;
 ...
 */
exports.updateWordFrequency = (0, firestore_2.onDocumentCreated)('users/{userId}/conversations/{conversationId}/messages/{messageId}', async (event) => {
        ...
        for (const word of words) {
            ...
            if (wordDoc.exists) {
                ...
                batch.update(wordRef, {
                    ...
                    lastUsed: firestore_1.Timestamp.now()
                });
            }
            else {
 ...
 */
exports.updateEmotionTrends = (0, firestore_2.onDocumentCreated)('users/{userId}/conversations/{conversationId}/messages/{messageId}', async (event) => {
    const snapshot = event.data;
    if (!snapshot)
        return;
    const messageData = snapshot.data();
    ...
    try {
        ...
        if (trendDoc.exists) {
            ...
            await emotionTrendRef.update({
                [`emotions.${messageData.emotion}`]: firestore_1.FieldValue.increment(1),
 ...
 */
exports.getEmotionalTrends = (0, https_1.onCall)(async (request) => {
 ...
 */
exports.getWordFrequency = (0, https_1.onCall)(async (request) => {
    // Ensure the user is authenticated
    if (!request.auth) {
        throw new Error('You must be logged in to use this feature.');
    }
    ...
    try {
        let query = db.collection(`word_frequency/${userId}/words`)
 ...
 */
exports.generateSessionSummaries = (0, https_1.onCall)({
        ...
        for (const conversationDoc of conversationsSnapshot.docs) {
          ...
          and any emotional themes present. Focus on being helpful and insightful.`;
                ...
                await conversationDoc.ref.update({
                    summary,
                    summaryGeneratedAt: firestore_1.Timestamp.now()
                });
                // Record usage stats
