...
exports.ensureAdminCollection = exports.initializeDefaultPrompts = exports.getPrompts = exports.deletePrompt = exports.createOrUpdatePrompt = void 0;
 ...
 */
exports.createOrUpdatePrompt = (0, https_1.onCall)(async (request) => {
 ...
 */
exports.deletePrompt = (0, https_1.onCall)(async (request) => {
    // Ensure the user is an admin
    if (!request.auth) {
        throw new Error('You must be logged in to use this feature.');
    }
 ...
 */
exports.getPrompts = (0, https_1.onCall)(async (request) => {
    // Ensure the user is an admin
    if (!request.auth) {
        throw new Error('You must be logged in to use this feature.');
    }
    ...
    try {
        let query = db.collection(PROMPTS_COLLECTION);
...
const initializeDefaultPrompts = async () => {
    try {
        ...
        await (0, exports.ensureAdminCollection)();
...
exports.initializeDefaultPrompts = initializeDefaultPrompts;
// Make sure settings/admin document exists
const ensureAdminCollection = async () => {
    try {
...
exports.ensureAdminCollection = ensureAdminCollection;
//# sourceMappingURL=adminPromptFunctions.js.map