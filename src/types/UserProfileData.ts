...
export interface UserProfileData {
  ...
  preferences: { username?: string; phoneNumber?: string; tone: string; theme: string; emotionCharacterSet: string; emotionIconSize: number; localStorageEnabled?: boolean;  security: {passPhrase: string;}};
